            ...
            <div class="col-xs-12">
                <div class="box box-success">
                    <div class="box-header">
                      <h3 class="box-title">Repair Description Table</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <table id="table_route" class="table table-bordered table-hover" >
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td ><?php echo $row['vr_cost']; ?></td>
                                         <td ><?php echo $row['vr_date']; ?></td>

                                        <td ><a style="color:white" href="/?page=vehicle/VrepairEdit&amp;edt_id=<?php echo $row['vr_id']; ?>">
                                        <button class="btn btn-info btn-xs" style="margin-left:10px">
                                        <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                                        Edit
                                        </button></a></td>

                                        <td ><a style="color:white" href="/?page=vehicle/VrepairDBCrud&amp;del_id=<?php echo $row['vr_id']; ?>">
                            ...
                            <tfoot>
                                <a href="/?page=vehicle/VechilesRepair" style="color:white">
