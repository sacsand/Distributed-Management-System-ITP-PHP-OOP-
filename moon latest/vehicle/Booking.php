                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select required name="driv_id" class="form-control">
                            ...
                            <div class="form-group">
                    <label class="col-sm-2 control-label">Select Route ID</label>
                    <div class="col-sm-10">
                        <select required name="rout_id" class="form-control">
                            <?php
                                while ($row = mysql_fetch_array($getrouteid)) {
