...
if(isset($_POST['update']))
{
    ...
    $caseMakeup = mysql_real_escape_string($_POST['caseMakeup']);
    ...
    $freeIssue = $_POST['Free_Issue_Rate'];
...
if($pid==$productId ){
    ...
    $crud->update($productId,$name,$weight,$caseMakeup,$unitPrice_ws,$casePrice_ws,$unitPrice_tf,$casePrice_tf,$priceConsumer,$category,$id,$freeIssue);
    header("Location:/?page=product/product_home");

}else if ($pid!=$productId && $count==0){
    ...
    header("Location:/?page=product/product_edit");
...
// insert
    ...
    if($count!=0){
        ...
        header("Location:/?page=product/add_records&count=1 ");
...
if(isset($_POST['stock'])) {
    ...
    header("Location:/?page=product/Sales_rep_add_daily_stock");
