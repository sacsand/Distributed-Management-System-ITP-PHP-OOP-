...
?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form action="/?page=product/dbcrud&amp;edt_id=<?php echo $_GET['edt_id'] ?>&amp;productId=<?php echo $row['productId'] ?>" method="post" class="form-horizontal" id="register-form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" name="weight" placeholder="city" class="form-control" value="<?php echo $row['weight'] ?>" />
