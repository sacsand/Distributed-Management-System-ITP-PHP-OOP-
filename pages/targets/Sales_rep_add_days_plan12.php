      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
            <h4> <a href="/?page=targets/Sales_rep_add_days_plan"><i class="fa  fa-angle-left"></i> Back</a></h4>
        ...
        <div class="col-md-12">
              ...
              <div class="col-md-6">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">last Month Sales According to Route</h3>
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <h6>Note : Refer the last month sales when Planing your Days Plans</h6>
                        <br>
                    ...
                    <table class='table table-bordered table-responsive'>
                        ...
                        ?>
                               ...
                               <tr>
                                    ...
                                    <td><?php echo $r2['RouteName'];  ?></td>
                                    <td><input type="number" min="0" name="lname1<?php echo $count; ?>" placeholder="days plan" class='form-control' /></td>
                        ...
                        <tr>
                            <td colspan="3">
                                ...
                                <button type="submit" name="save_mul" class="btn btn-danger btn-block btn-sm" ><i class="glyphicon glyphicon-plus"></i> &nbsp;Add DaysPlan</button>
