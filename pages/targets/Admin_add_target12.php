    ...
    //  echo "is ".$RouteCount;
      ...
      $DaysPlanCount=$TerPlanObj->CountDaysPlanRows($productid);
     ...
     // $target=$TerPlanObj->GetTarget($Teratory,$productid);
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
            <h4> <a href="/?page=targets/Admin_add_target"><i class="fa  fa-angle-left"></i> Back</a></h4>
    ...
    <div class="row">
        <div class="col-md-12">
              ...
              <div class="col-md-6">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">last Month sales According to Areas</h3>
                ...
                <div class="box-footer no-padding">
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            ?>
                            <li><a href="#"><?php echo $r1['AreaName'];  ?> <span class="pull-right text-blue"> <?php echo $r1['sum']; ?></span></a></li>
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <i class="fa fa-bar-chart-o"></i>
                    <h3 class="box-title">Add Area Target</h3>
                    <div class="box-tools pull-right">
                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                        <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        if($RouteCount==$DaysPlanCount) {
                           ...
                           echo '<h4>Your Current Target</h4>' ;
                            ...
                            $res3 = $TerPlanObj->GetThisMonthDaysPlan($productid); ?>
                ...
                <form method="post" name="frm" >
                    <table class='table table-bordered table-responsive'>
                        ...
                        <?php
                        $res2 = $TerPlanObj->GetRootByTeretory();
                        $count=0;
                        ...
                        ?>
                               ...
                               <tr>
                                    ...
                                    <td><?php echo $r2['AreaName'];  ?></td>
                                    <td><input type="number" min="0" name="lname1<?php echo $count; ?>" placeholder="Target" class='form-control' required/></td>
                                    <input type="hidden" name="lname2<?php echo $count; ?>" placeholder="Target" value="<?php echo $productid ?>" class='form-control' />
                                    <input type="hidden" name="lname3<?php echo $count; ?>" placeholder="Target" value="<?php echo $r2['AreaId'];  ?>" class='form-control' />
