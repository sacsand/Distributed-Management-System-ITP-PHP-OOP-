...
?>
  ...
  <div class="panel-body">
              ...
              <form action="/?page=stock/STOCK_CRUD&amp;IndexNo=<?php echo $Index_No ?>" method="post" name="RemoveStock" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="current_stock" value="<?php echo $currentStock ;?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-1">
                        <button type="submit" value="Save" name="RemoveStock" class="btn btn-danger" onclick="myFunction()">Remove</button>
                    </div>
