        ...
        <section class="content">
            <form action="/?page=vehicle/DriverDBCrud" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Driver ID</label>
                    <div style="padding-left:15px; padding-right:15px" class="input-group col-sm-10">
                        <span class="input-group-addon info">D</span>
                        <input  type="text"name="d_id"required placeholder="Driver ID" class="form-control"value="<?php echo $nextId?>" readonly/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" pattern="[Aa-zZ]+" name="d_name" required placeholder="Please Insert Driver Name" class="form-control" value="" />
