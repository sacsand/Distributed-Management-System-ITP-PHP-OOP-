...
<div class="catalogue_wrapper">
    <div class="catalogue_wrapper_left">
        ...
        <a href="/?page=catalogue-item&amp;category=<?php echo
        $category['id']; ?>&amp;id=<?php echo $row['id']; ?>"><img src="<?php echo $image; ?>" alt="<?php echo Helper::encodeHtml($row['name'], 1); ?>" width="<?php echo $width; ?>" /></a>
    </div>
    <div class="catalogue_wrapper_right">
        ...
        <p><?php echo Basket::activeButton($row['id']); ?></p>
            ...
            ?>
<p>There are no products in this categery</p>
        <?php
        }
