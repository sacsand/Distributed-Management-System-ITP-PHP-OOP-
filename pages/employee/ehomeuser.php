...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
          Add User
            <small>Main Company Users,Admin,Manager,Staff</small>
        </h1>
            ...
            <div class="col-xs-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#fa-icons" data-toggle="tab">Users</a></li>
                        <li><a href="#glyphicons" data-toggle="tab">Add User</a></li>
                                    ...
                                    <table id="device_table" class="table table-bordered table-hover" >
                                        ...
                                        while($row = mysql_fetch_array($res))
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td ><a style="color:white" href="/?page=employee/eUserEdit&amp;edt_Id=<?php echo $row['IndexNo']; ?>">
                    ...
                    <div class="tab-pane" id="glyphicons">
                        ...
                        <form action="/?page=employee/employeeDBCRUD" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="hidden" id = "territoryList" name="territoryList" value="NULL" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select id = "Etype" name="Etype" class="form-control" required oninvalid="this.setCustomValidity('Please select the employee type')"
                                        ...
                                        <option   value = "Staff L1">Staff Level 1</option>
                                        <option   value = "Staff L2">Staff Level 2</option>
                                        <option   value = "Staff L3">Staff Level 3</option>
