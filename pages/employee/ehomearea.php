            ...
            <div class="col-xs-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#fa-icons" data-toggle="tab">Add User</a></li>

                        <li><a href="#glyphicons1" data-toggle="tab">Add Area Managers </a></li>
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <table id="device_table" class="table table-bordered table-hover" >
                                        ...
                                        <?php
                                        $res = $crud->read_areamanager();
                                        while($row = mysql_fetch_array($res))
                                        {
                                            $TeratoryName=$StockObj->Get_Sales_rep_Area_Name($row['teretoryId']);
                                            ?>
                                            <tr>
                                                ...
                                                <td ><a style="color:white" href="/?page=employee/eAreaEdit&amp;edt_Id=<?php echo $row['IndexNo']; ?>">
                                                        <button class="btn btn-info btn-xs" style="margin-left:10px" >
                                                            <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                                                            Edit
                                                        </button></a></td>

                                                <td ><a style="color:white" href="/?page=employee/areaDB&amp;rem_id=<?php echo $row['IndexNo']; ?>">
                                                ...
                                                <?php
                                                if($row['active']=='0'){
                                                ?> <td ><a style="color:white" href="/?page=employee/areaDB&amp;Inact_id=<?php echo $row['IndexNo']; ?>">
                                        ...
                                        <span class="glyphicon glyphicon-remove-circle " aria-hidden="true" ></span>';
                                                        ...
                                                        ?> <td ><a style="color:white" href="/?page=employee/areaDB&amp;act_id=<?php echo $row['IndexNo']; ?>">
                                                                <?php
                            ...
                            <form action="/?page=employee/employeeDBCRUD" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id = "Etype" name="Etype" class="form-control" required  oninvalid="this.setCustomValidity('Please select the employee type')"
                                            ...
                                            <option  selected="selected"  value = "Area_Manager">Area Manager</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-1">
                                        ...
                                        <button type="submit" name="save_area" class="btn btn-success btn-sm" >
