...
//
$profit=$OveObj->total_profit($Teratory);//up to today -of all products

$total_value=$OveObj->total_total_value($Teratory);//

$sales=$OveObj->total_sales($Teratory);//

$freeis=$OveObj->total_freeissue($Teratory);
//
...
?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Dashboard - <?php echo $TeratoryName; ?>
                <small></small>
            </h1>
                            ...
                            <div class="row">
                                <div class="col-sm-3 col-xs-6">
                                    <div class="description-block border-right">
                                        ...
                                        <h5 class="description-header">RS <?php echo $sales; ?></h5>
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <table class="table no-margin">
                                    ...
                                    <tbody>
                                    <?php $res = $OveObj->brought_fw_sale($Teratory) ;
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <table class="table no-margin">
                                    ...
                                    <tbody>
                                    <?php $res = $OveObj->sales_by_produt($Teratory) ;
...

                                    {
                                        ...
                                        $target=$OveObj->GetTarget($Teratory, $productidx) ;
                                        $percentage=$OveObj->CalculatePrecentage($salesx, $target);
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table class="table no-margin">
                                ...
                                <tbody>
                                <?php $resx = $OveObj->stock_level($Teratory) ;
...

                                {
                                    ...
                                    $percentage=$OveObj->CalculatePrecentage($quantity,$max_stock);
...
<!-------chart---chart----chart-chart------------------------------------------------------------------>
                        ...
                        <div class="box-footer no-padding">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <?php
                                $res1 = $OveObj->sales_by_route($Teratory);
                                while($r1 = mysql_fetch_array($res1))
                                { ?>

                                    <li><a href="#"><?php echo $r1['RouteName'];  ?> <span class="pull-right text-red"> <?php echo $r1['sales']; ?></span></a></li>
...
<script>
    ...
    var pieData = [
        <?php
           $res = $OveObj->sales_by_route($Teratory);
