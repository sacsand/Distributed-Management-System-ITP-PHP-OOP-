...
$salesRepName=$DsrObj->Get_sales_rep_name($Teratory);
...
?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h4> <a href="/?page=salesreports/AdminSalesReportHome"><i class="fa  fa-angle-left"></i> Back</a></h4>
            <h1>
                Monthly Sales Report Of the <b><?php echo $TeratoryName ; ?></b>
                <small><?php echo $today ?></small>
            </h1>
            <h4>
                Sales Person - <?php echo $salesRepName;?>
            </h4>
