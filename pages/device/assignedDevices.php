            ...
            <div class="col-xs-12">
                <div class="box box-success">
                    <div class="box-header">
                      <h3 class="box-title">Assigned Devices Table</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <table id="device_table" class="table table-bordered table-hover" >
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td ><a style="color:white" href="/?page=device/deviceLogEdit&amp;editDevice_Id=<?php echo $row['deviceId']; ?>">
                                        <button class="btn btn-info btn-xs" style="margin-left:10px">
                                        <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                                        Edit
                                        </button></a></td>

                                        <td ><a style="color:white" href="/?page=device/deviceDBCRUD&amp;remAssign_id=<?php echo $row['deviceId']; ?>">
                            ...
                            <tfoot>
                                <a href="/?page=device/assignDevices" style="color:white">
