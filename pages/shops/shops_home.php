...
$shops = new SHOPS();
    ...
    $route_id=URL::getParam('route_id');
...
?>
            <script>
                  alert("Failure(this shopId is in use)!");  
            </script>
<?php
        } 
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <tr>
                            <th>
                            <h4><a href="/?page=shops/shops_main" class=".btn.btn-app"><button class="btn btn-danger btn-xs">Home</button>
          
                        
                             
                            <a href="/?page=shops/shops_add_records&amp;routeId=<?php echo $route_id?>"><button class="btn btn-success btn-xs">Add</button></a></td></h4>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="/?page=shops/shops_dbcrud&amp;del_id=<?php echo $row['indexNo']; ?>&amp;route_id=<?php echo $row['routeId']; ?>"><button class="btn btn-danger btn-xs">Delete</button></a></td>
