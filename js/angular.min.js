/**
 * Created by sachintha on 8/22/15.
 */
/*
 AngularJS v1.2.3
...
(function(X, O, r) {
    ...
    function A(b) {
        return function() {
            var a = arguments[0],
                c, a = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.2.3/" + (b ? b + "/" : "") + a;
    ...
    function Aa(b, a) {
        ...
        if (c == typeof a &&
            ...
            if (K(b)) {
                ...
                for (d in a)
                    if (!c.hasOwnProperty(d) && "$" !== d.charAt(0) && a[d] !== r && !I(a[d])) return !1;
                return !0
            }
        return !1
    }
            ...
            if (!d || null != b)
                for (; e.length;)
                    for (k = e.shift(), l = 0, n = k.length; l < n; l++)
                        for (p = x(k[l]), m ? p.triggerHandler("$destroy") : m = !m, s = 0, p = (D = p.children()).length; s <
                        p; s++) e.push(Ba(D[s]));
    ...
    function ka(b, a, c) {
        var d = b[eb],
            d = Ra[d || -1];
        if (B(c)) d || (b[eb] = d = ++Wc, d = Ra[d] = {}), d[a] = c;
        else return d && d[a]
    }
    ...
    function cd(b, a, c, d) {
        ...
        h.cookies = function(a, b) {
            var d, e, h, g;
            if (a) b === r ? m.cookie = escape(a) + "=;path=" + da + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : w(b) && (d = (m.cookie = escape(a) + "=" + escape(b) + ";path=" + da).length + 1, 4096 < d && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!"));
            else {
                if (m.cookie !== Z)
                    for (Z = m.cookie, d = Z.split("; "), E = {}, h = 0; h < d.length; h++) e = d[h], g = e.indexOf("="), 0 < g && (a = unescape(e.substring(0,
    ...
    function gc(b, a) {
                ...
                function(b, d) {
                    ...
                    q(c[a], function(c, g) {
                        try {
                            ...
                            I(f) ? f = {
                                compile: ba(f)
                            } : !f.compile && f.link && (f.compile = ba(f.link));
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri",
            function(a, b, l, n, p, s, D, u, Q, z, Y, H) {
                ...
                function Z(a, b, c, d, f) {
                    ...
                    switch (a.nodeType) {
                        case 1:
                            ...
                            a = a.className;
                            if (w(a) && "" !== a)
                                for (; m = g.exec(a);) p = ma(m[2]), la(b, p, "C", d, f) && (c[p] = $(m[3])), a = a.substr(m.index + m[0].length);
                            break;
                        case 3:
                            t(b, a.nodeValue);
                            break;
                ...
                function N(a, c, d, e, g, f, m, n, p) {
                    ...
                    var H = -Number.MAX_VALUE,
                        R, z = p.controllerDirectives,
                        E = p.newIsolateScopeDirective,
                        N = p.templateDirective;
                    ...
                    for (var la = !1, Ga = !1, v = d.$$element = x(c), G, ea, t, F = e, A, L = 0, M = a.length; L < M; L++) {
                        ...
                        !G.templateUrl && G.controller && (t = G.controller, z = z || {}, C("'" + ea + "' controller", z[ea], G, v),
                            z[ea] = G);
                        if (t = G.transclude) la = !0, G.$$tlb || (C("transclusion", p, G, v), p = G), "element" == t ? (Ga = !0, H = G.priority, t = da(c, Va, Fa), v = d.$$element = x(O.createComment(" " + ea + ": " + d[ea] + " ")), c = v[0], S(g, x(ta.call(t, 0)), c), F = y(t, e, H, f && f.name, {
                            nonTlbTranscludeDirective: p
                        })) : (t = x(zb(c)).contents(), v.html(""), F = y(t, e));
                        if (G.template)
                            if (C("template", N, G, v), N = G, t = I(G.template) ? G.template(v, d) : G.template, t = hc(t), G.replace) {
                                f = G;
        ...
        this.$get = ["$injector", "$exceptionHandler", "$parse", "$browser",
            function(c, d, e, g) {
                ...
                f.prototype = {
                    constructor: f,
                    $new: function(a) {
                        a ? (a = new f, a.$root = this.$root, a.$$asyncQueue = this.$$asyncQueue, a.$$postDigestQueue = this.$$postDigestQueue) : (a = function() {}, a.prototype = this, a = new a, a.$id = Za());
                        a["this"] = a;
                        a.$$listeners = {};
                        a.$parent = this;
                    ...
                    $watchCollection: function(a, b) {
                        ...
                        return this.$watch(function() {
                            ...
                            if (V(f))
                                if (pb(f))
                                    for (d !== k && (d = k, l = d.length = 0, g++), a = f.length, l !== a && (g++, d.length = l = a), b = 0; b < a; b++) d[b] !== f[b] && (g++, d[b] = f[b]);
                                else {
                                    d !== m &&
                                    (d = m = {}, l = 0, g++);
                                    a = 0;
                                    ...
                                    if (l > a)
                                        for (b in g++, d) d.hasOwnProperty(b) && !f.hasOwnProperty(b) && (l--, delete d[b])
                                } else d !== f && (d = f, g++);
                            return g
                        }, function() {
                            b(f, d, c)
                    ...
                    $digest: function() {
                        ...
                        do {
                            ...
                            do {
                                ...
                                if (!(g = y.$$childHead || y !== this && y.$$nextSibling))
                                    for (; y !== this && !(g = y.$$nextSibling);) y = y.$parent
                            } while (y = g);
        ...
        this.$get = function() {
            return function(c, d) {
                var e = d ? a : b,
                    g;
                if (!M || 8 <= M)
                    if (g = wa(c).href, "" !== g && !g.match(e)) return "unsafe:" + g;
                return c
            }
        }
    }
    ...
    function Cd() {
        this.$get = ["$window", "$document",
            function(b, a) {
                var c = {}, d = S((/android (\d+)/.exec(t((b.navigator || {}).userAgent)) || [])[1]),
    ...
    function Fc(b, a) {
        ...
        d.$setValidity = function(a, b, h) {
            var n = f[a];
            if (b) n && (La(n,
                h), n.length || (g--, g || (c(b), d.$valid = !0, d.$invalid = !1), f[a] = !1, c(!0, a), e.$setValidity(a, !0, d)));
            else {
                g || c(b);
                if (n) {
                    if (-1 != bb(n, h)) return
    ...
    var Sc = /[A-Z]/g,
        ...
        }, Ra = L.cache = {}, eb = L.expando = "ng-" + (new Date).getTime(),
        Wc = 1,
        Gc = X.document.addEventListener ? function(b, a, c) {
    ...
    q({
        ...
        attr: function(b,
            ...
            if (gb[d])
                ...
                else return b[a] || (b.attributes.getNamedItem(a) || v).specified ? d : r;
        ...
        readString: function(a) {
            ...
            for (var d = "", e = a, g = !1; this.index < this.text.length;) {
                var f = this.text.charAt(this.index),
                    e = e + f;
                if (g) "u" === f ? (f = this.text.substring(this.index + 1, this.index + 5), f.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + f + "]"), this.index += 4, d += String.fromCharCode(parseInt(f, 16))) : d = (g = Sd[f]) ? d + g : d + f, g = !1;
                else if ("\\" === f) g = !0;
                else {
                    if (f === a) {
                        this.index++;
    ...
    var Hc = function(a) {
        ...
        Ia = "ng-pristine",
        nb = "ng-dirty",
        Zd = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse",
            function(a, c, d, e, g) {
                function f(a, c) {
                    c = c ? "-" + db(c, "-") : "";
                ...
                return {
                    ...
                    link: function(e, g, f, h, m) {
                        ...
                        e.$watchCollection(h, function(a) {
                            ...
                            h = F.length = C.length;
                            for (f = 0; f < h; f++)
                                if (N = a === C ? f : C[f], T = a[N], T = n(N, T, f), va(T, "`track by` id"), B.hasOwnProperty(T)) w = B[T], delete B[T], v[T] = w, F[f] = w;
                                else {
                    ...
                    link: function(e, f, h, m) {
                        ...
                        function n(e, f, g) {
                            function h() {
                                ...
                                if (v)
                                    if (x && K(t))
                                        for (r = new Sa([]), J = 0; J < t.length; J++) A[l] = t[J], r.put(x(e, A), t[J]);
                                    else r = new Sa(t);
                                    ...
                                    e.$apply(function() {
                                        ...
                                        if (v)
                                            for (k = [], p = 0, u = y.length; p < u; p++)
                                                for (a = y[p], m = 1, t = a.length; m < t; m++) {
                                                    if ((h = a[m].element)[0].selected) {
                                                        h = h.val();
                                                        n && (d[n] = h);
                                                        if (x)
                                                            for (w = 0; w < c.length && (d[l] = c[w], x(e, d) != h); w++);
                                                        else d[l] = c[h];
                                                        k.push(q(e, d))
                                                    }
                        ...
                        if (m[1]) {
                            var p = m[0],
                                ...
                                t = h.ngOptions,
                                w = !1,
                                z, F = x(O.createElement("option")),
                                H = x(O.createElement("optgroup")),
                                y = F.clone();
                            m = 0;
                            for (var A = f.children(), I = A.length; m < I; m++)
                                if ("" === A[m].value) {
                                    z = w = A.eq(m);
                                    break
                                }
