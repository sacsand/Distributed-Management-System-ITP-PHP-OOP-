...
?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="/?page=RouteHome"><i class="fa fa-dashboard"></i> Home</a></li>
        ...
        <section class="content">
            <form action="/?page=AreaDBCrud&amp;route_edt_id=<?php echo $_GET['route_edt_id'] ?>" method="post" class="form-horizontal">

                <div class="form-group">
                    <label class="col-sm-2 control-label">Route Id</label>
                    <div class="col-sm-10">
                        <input type="text" name="route_id" placeholder="Route ID" required pattern="^[R]{1}[0-9]{2}[T]{1}[0-9]{2}[A]{1}[0-9]{2}$" oninvalid="setCustomValidity('Route ID should not be longer than the specified pattern and have to match the pattern. The pattern should be like this R##T##A##')" oninput="setCustomValidity('')" class="form-control" value="<?php echo $row['RouteId'] ?>" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">Select Territory ID</label>
                    <div class="col-sm-10">
                        <select name="terr_id" class="form-control">
                            <?php
                                while ($row = mysql_fetch_array($territoryIdList)) {
                                    echo '<option value="'.$row['TeretoryId'].'">'.$row['TeretoryId'].'</option>';
                                }
                            ?>
                        </select>
                    </div>
